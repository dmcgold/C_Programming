...
// Code obtained from https://github.com/petewarden/c_hashMap/blob/master/hashMap.c
...
unsigned int HashCode(char* keystring){
...
void AddNode(mStruct **List,char *Key,int Val)
{
	struct mStruct *Head=*List;
	struct mStruct *Temp;
...
int Add(char *Key,int Value,mStruct hashMap[])
{
